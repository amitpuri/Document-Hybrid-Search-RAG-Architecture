...
class SearchResult:
    ...
    strategy: str          # Name of the strategy used (e.g., '8. RRF + Dedup + MMR')
```

### 3. `MetricScores`
Container for standard information retrieval evaluation metrics:
```python
@dataclass
class MetricScores:
...
```python
from src.common import DocumentChunk, SearchResult, tokenize, jaccard_similarity
